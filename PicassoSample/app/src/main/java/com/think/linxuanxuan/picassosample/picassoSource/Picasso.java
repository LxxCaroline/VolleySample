...
import static com.think.linxuanxuan.picassosample.picassoSource.Action.RequestWeakReference;
import static com.think.linxuanxuan.picassosample.picassoSource.Dispatcher.HUNTER_BATCH_COMPLETE;
import static com.think.linxuanxuan.picassosample.picassoSource.Dispatcher.REQUEST_BATCH_RESUME;
import static com.think.linxuanxuan.picassosample.picassoSource.Dispatcher.REQUEST_GCED;
import static com.think.linxuanxuan.picassosample.picassoSource.MemoryPolicy.shouldReadFromMemoryCache;
import static com.think.linxuanxuan.picassosample.picassoSource.Picasso.LoadedFrom.MEMORY;
      ...
      while (true) {
        try {
          ...
          RequestWeakReference<?> remove =
              (RequestWeakReference<?>) referenceQueue.remove(Utils.THREAD_LEAK_CLEANING_MS);
